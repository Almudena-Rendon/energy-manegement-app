...
const Navbar = () => {
  ...
  return (
    <>
   <header className={`${isLogged ? "bg-white/50 dark:bg-gray-900 border-gray-200 dark:border-gray-600" : "bg-gray-900 border-gray-600"} fixed w-full z-20 top-0 start-0 border-b `}> 
