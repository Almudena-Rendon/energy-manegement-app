...
const Navbar = () => {
  ...
  return (
    <>
   <header className={` bg-white/50 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600`}> 
    <nav className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <IconLeaf />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Energy App</span>
  </a>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    ...
    {/* {isDrawerOpen && (
      <Drawer navLinks={navLinks} onClose={handleDrawerClose} />
    )} */}
   </header>
  </>
  )
